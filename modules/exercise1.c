...
void parallel_updating_grid(int*** grid,int***temp_grid,int num_of_threads){
    #pragma omp parallel for(num_of_threads) schedule(static)
...
//         else{
//            while(num_of_births>0){
//                 parallel_updating_grid(&grid,&temp_grid,number_of_threads);
//                 num_of_births--;
//            }
//         }
